...
-- Coupons, made on the Coupons page. One per bill; see _coupon_quote.
...
revoke all on function
  ...
  public.delete_menu_item(uuid, bigint), public.create_order(uuid, text, text, jsonb, text, text),
...
revoke all on function
  public.check_coupon(uuid, text, text, jsonb),
